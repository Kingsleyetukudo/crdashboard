...
<div class="buttons">
  <button id="2000" @click="getData4">
  2000
  </button>
  <button id="2004" @click="getData1">
  2004
  </button>
  <button id="2008" @click="getData2">
  2008
  </button>
  <button id="2012" >
  2012
...
export default {
    ...
    setup(props) {
        ...
        const compaColumnChart = ref(null)
...
onMounted(() => {
  ...
  exporting: {
    ...
    compaColumnChart.value = new Highcharts.chart(colCompa)
